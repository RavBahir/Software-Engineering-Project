...
const loadImage = () => {
    ...
    previewImg.addEventListener("load", () => {
        resetFilterBtn.click(); // clicking reset button, so the filter value reset if the user select new img
...
rotateOptions.forEach(option => {
    option.addEventListener("click", () => { // adding click event listener to all rotate/flip button
        if(option.id === "left") {
        ...
        } else if(option.id === "horizontal") { // if fliphorozontal value is 1, set this value to -1 else set 1
